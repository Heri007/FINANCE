...
export const receivablesService = {
  ...
  async getAll() {
    try {
      ...
      throw new Error(`Impossible de charger les receivables: ${error?.message || 'Erreur réseau'}`);
    }
  },
  ...
  async getById(id) {
    try {
      ...
      throw new Error(`Receivable #${id} introuvable: ${error?.message || 'Erreur réseau'}`);
    }
  },
  ...
  try {
    ...
    throw new Error(`Impossible de créer le receivable: ${error?.message || 'Erreur réseau'}`);
  }
},
  ...
  async update(id, data) {
    try {
      ...
      throw new Error(`Impossible de modifier le receivable #${id}: ${error?.message || 'Erreur réseau'}`);
    }
  },
  ...
  async delete(id) {
    try {
      ...
      throw new Error(`Impossible de supprimer le receivable #${id}: ${error?.message || 'Erreur réseau'}`);
    }
  },
  ...
  async pay(id) {
    try {
      ...
      throw new Error(`Impossible de marquer le receivable #${id} comme payé: ${error?.message || 'Erreur réseau'}`);
    }
  },
  ...
  async restore(data) {
    try {
      ...
      throw new Error(`Impossible de restaurer le receivable: ${error?.message || 'Erreur réseau'}`);
    }
  }
};

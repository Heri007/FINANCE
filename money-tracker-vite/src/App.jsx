...
{showAdd && (
  ...
  />
      ...
      <ProjectPlannerHub
        key={editingProject?.id ? `project-${editingProject.id}` : 'new-project'}
        ...
        onProjectSaved={handleProjectUpdated}  // ← Même fonction, pas de re-render
        onProjectUpdated={handleProjectUpdated}  // ← Même fonction, pas de re-render

...
export function AccountModal({ onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 relative">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Solde Initial</label>
            <input 
              type="number" 
